...
<head>
  <meta charset="utf-8" />
  <title>Totalvdo Cloud Media Player</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>assets/new_kimble/js/datatables/datatables.css" type="text/css" />
  
  <link rel="stylesheet" href="<?php echo base_url()?>assets/new_kimble/js/datepicker/datepicker.css" type="text/css" />
  <link rel="stylesheet" href="<?php echo base_url()?>assets/new_kimble/js/slider/slider.css" type="text/css" />
  ...
  <link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>dist/css/jquery.steps.css">
...
<body>
  <section class="hbox stretch">
	...
	<aside class="bg-primary aside-sm" id="nav">
      <section class="vbox">
        <header class="dker nav-bar nav-bar-fixed-top" style="background-color:#e5e5e9">
          <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen" data-target="#nav">
            <i class="fa fa-bars"></i>
          </a>
          <!--<a href="#" class="nav-brand" data-toggle="fullscreen">kimbl</a> -->
			
		<a href="#" class="nav-brand" data-toggle="fullscreen">
		  <img src="<?php echo base_url()?>images/TotalVDO.png" style="margin: 18px 18px; width: 140px;">
		  </a>	
