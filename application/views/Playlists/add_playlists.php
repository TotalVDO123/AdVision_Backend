...
<form action="<?php echo base_url() ?>Playlists/addplaylists" method="post" >
  <div class="form-group">
    <label style="color:#fff;" >Playlist Name</label>
    <input type="text" class="form-control" name="playlist_name"  aria-describedby="PlaylistHelp" placeholder="Playlist Name" required >
