                    ...
                    <?php //echo "<pre>"; print_r($result);
					 foreach($result->gallery as $data): 
						echo "<div class='col-md-2 col-sm-2 col-xs-2 pb-2 pt-2' style='background-url'>";
							if($data['file_type'] == "1"){ 
								echo "<img width='150' src=".$data['file_upload'].">";							
							}else{
	  ...
	  <div class="row">
        <div class="col-sm-12 gallerycanvas">
			...
			else
			{
                ...
                <option value="1" <?php if($row['image_display_type']==1){ echo "selected"; } ?>  >accordion</option>
                <option value="2" <?php if($row['image_display_type']==2){ echo "selected"; } ?> >backgroung to fonegroumd</option>
				<option value="3" <?php if($row['image_display_type']==3){ echo "selected"; } ?> >cubien</option>
				<option value="4" <?php if($row['image_display_type']==4){ echo "selected"; } ?> >depthpage</option>
				<option value="5" <?php if($row['image_display_type']==5){ echo "selected"; } ?>>fade</option>
				<option value="6" <?php if($row['image_display_type']==6){ echo "selected"; } ?> >fliphorizental</option>
				<option value="7" <?php if($row['image_display_type']==7){ echo "selected"; } ?> >flippage</option>
				<option value="8" <?php if($row['image_display_type']==8){ echo "selected"; } ?> >foreground to bacground</option>
				<option value="9" <?php if($row['image_display_type']==9){ echo "selected"; } ?>>rotatedown</option>
				<option value="10" <?php if($row['image_display_type']==10){ echo "selected"; } ?> >rotateup</option>
				<option value="11" <?php if($row['image_display_type']==11){ echo "selected"; } ?>>stack</option>
				<option value="12" <?php if($row['image_display_type']==12){ echo "selected"; } ?> >tablet</option>
				<option value="13" <?php if($row['image_display_type']==13){ echo "selected"; } ?> >zoomin</option>
				<option value="14" <?php if($row['image_display_type']==14){ echo "selected"; } ?>>zoomoutsingle</option>
				<option value="15" <?php if($row['image_display_type']==15){ echo "selected"; } ?>>zoomout</option>
				</select> 
				</div>
				</div>
				</li> 
