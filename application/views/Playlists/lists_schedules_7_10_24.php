...
?>
  ...
  <section class="category">
    <div class="container">
        ...
        <h4 style="color:#FFF;">Playlists Schedules</h4>
		...
		<?php
          ...
          <div class="col-md-3" style= "background-color: #71c8fa;border-radius:10px 10px 10px 10px;color:white;" onclick="window.open('<?php echo base_url() ?>Playlists/playlistschedule/<?php echo $playlist['id']  ?>','mywindow');"  >
            
             
             
			   <p class="text-center"> <strong>  <?php echo $playlist['name']; ?>  </strong></p>
