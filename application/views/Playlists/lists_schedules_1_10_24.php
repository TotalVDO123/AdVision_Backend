  ...
  <section class="category">
    <div class="container">
		...
		<?php
          ...
          <div class="col-md-3" style= "background-color: black;" onclick="window.open('<?php echo base_url() ?>Playlists/playlistschedule/<?php echo $playlist['id']  ?>','mywindow');"  >
            
             
              <strong>  <?php echo $playlist['name']; ?> Schedules  </strong>
