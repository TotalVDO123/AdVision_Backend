...
?>
  ...
  <section class="category">
    <div class="container">
        ...
        <h4 style="color:#FFF;">Edit Schedules</h4>
...
<form action="<?php echo base_url() ?>Playlists/editschedule/"<?php echo $schedules[0]['id'] ?> method="post" >
  <div class="form-group">
    <label style="color:#fff;" >Schedules Name</label>
	
    <input type="text" class="form-control" name="schedules_name"  value="<?php echo $schedules[0]['name'] ?>" placeholder="Schedules Name" required >
    <small id="emailHelp" class="form-text text-muted"></small>
  </div>
	 <div>&nbsp;</div>
  <input type="hidden" class="form-control" name="schedules_id"  value="<?php echo $schedules[0]['id'] ?>"  >
