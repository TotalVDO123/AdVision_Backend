...
?>
  ...
  <section class="play">
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
           ...
           <!-- <div class="video" id="show_hide_video11" style="display:none;" >
			...
			{	
			if($playlist_gallery[0]['file_type']==2)
			{
			
		
			?>
    			<div class="video"  >
                  <video id="show_hide_video" width="100%" height="300" controls>
                    <source  src="<?php echo $playlist_gallery[0]['file_upload'] ?>" type="video/mp4">
                  </video>
                </div>
			
			     <img id="image1" src="" alt="Dinosaur" width="100%" height="300" style="display:none;" />
			<?php
			}
			else
			{
			?>
              ...
              <video id="video1" width="100%" height="300" controls>
			    ...
			    <img id="image1" src="<?php echo $playlist_gallery[0]['file_upload'] ?>" alt="Dinosaur" width="100%" height="300"  />
    ...
    <tr>
     ...
     <th>Delete</th>
			...
			//echo "============". $playlist_gallery[0]['file_upload'];
			...
			<th  class="video-category" id="<?php echo $row['screen_id'] ?>">   
					...
					?>
								 ...
								 <div onclick="play_season('<?php echo $row['file_upload']?>')" >
								 <video width='120' height='100%' style='border:3px solid #000;'  controls>
					...
					if($row['file_type']==3)
					{
								...
								{
									$data['file_type']=1;
									echo "<img width='110' height='100' src=".$row['file_upload']." style=' border: 3px solid #000;' >";	
								}
            ...
            <th  id="<?php echo 'duration_'. $row['screen_id'] ?>">
			 <div class="item">
			 <button class="quantity-minus" onclick="azalt(this);updateElements( <?php echo $row['screen_id'] ?> , <?php echo $row['playlist_id']  ?>)">-</button>
			  ...
			  <button class="quantity-plus"  onclick="arttir(this);updateElements( <?php echo $row['screen_id'] ?> , <?php echo $row['playlist_id']  ?>)">+</button>
               ...
               <th id="<?php echo 'del_'. $row['screen_id'] ?>" >
  ...
  <div class="row">
       <label for="scrolling_text" style="color:#FFFF" >Scrolling Text</label>   
    <div class="col">
    
      <input type="text" class="form-control" name="scrolling_text" id="scrolling_text" value="<?php echo $row_playlist[0]['scrolling_text'] ?>" placeholder="Scrolling Text">
    </div>
    <div class="col">
       <input type="checkbox" class="form-check-input" id="scrolling_check" name="scrolling_check" <?php if ($row_playlist[0]['scrolling_check'] == 1) { echo "checked='checked'"; } ?> value="1" >
    </div>
    
    
    
    
    <label for="scrolling_text" style="color:#FFFF">Rss Feed</label>   
    <div class="col">
    
    
    <input type="hidden" class="form-control" name="playlist_id" value="<?php echo $row['playlist_id']; ?>" >
      <input type="text" class="form-control" name="rss_feed" name="rss_feed" value="<?php echo $row_playlist[0]['rss_feed'] ?>" placeholder="Rss Feed">
    </div>
    <div class="col">
      <input type="checkbox" class="form-check-input" name="rss_feed_check" value="1" <?php if ($row_playlist[0]['rss_feed_check'] == 1) { echo "checked='checked'"; } ?> id="rss_feed_check">
   ...
   <div class="row">
    ...
    <div class="col">
	  ...
	  <div class="gallery-btn" align="left">
          ...
          <?php /* ?>
          <button style="float:right;" onclick="location.href = '<?php echo base_url() ?>screens/add'"  class="btn btn-primary" id="show"> Upload File</button>
        <?php */ ?>
        </div>
			...
			<?php //echo "<pre>"; print_r($result);
					 foreach($result->gallery as $data): 
						...
						echo "<a href='javascript:void(0)' screen_id=". $data['id']." class='del_screen' ><i class='fa fa-close'></i></a>";
							if($data['file_type'] == "1"){ 
				echo "<img width='110' height='100' src=".$data['file_upload']." style=' border: 3px solid #FFF;' >";
						...
						elseif($data['file_type'] == "2")
							{
								echo "<video width='110' height='100' style='border:3px solid #FFF;
' controls>";
							...
							{
							$data['file_type']=6;
							echo '<iframe src="'.$data['file_upload'].'" scrolling="no" frameborder="0" allowfullscreen=true width="110" height="100" ></iframe>';
...
' controls>";
							...
							<span class='float-right'><i  class='fa fa-plus-square fa-6' aria-hidden='true' onClick="image(<?php echo "'".$data['file_upload']."', ".$data['id'].','.$data['file_type'];?>)"></i></span>   
							    ...
							    <?php echo substr($file_name,0,20) ?> 
...
<script>
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>/playlists/update_scrolling_rssfeed",
