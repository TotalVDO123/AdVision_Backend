...
<div class="row">
    ...
    <div class="col-sm text-end">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Add New </button> <!-- Modal -->
    </div>
...
?>		
   ...
   <?php
   //print_r($gallery);
   foreach($gallery as $row1)
   {
   ?>
  <div class="row row-cols-6 g-4">
  <div>
      
    <h5 style="color:#FFF;"><?php echo  $row1['company_name'] ?></h5>
  ...
  <?php
    ...
    $sql = "SELECT * FROM  screens WHERE 1	and user_id='".$row1['user_id']."'";
  ...
  <div class="col"  >
  <div class="del_screen" screen_id="<?php echo $row['id']; ?>" ><i class="fa fa-trash-o"></i></div>
    <div class="card" >
	  ...
	  <?php */ ?>
		 ...
		 <?php
					...
					<img id="image1" screen_id="<?php echo $row['screen_id']; ?>"  onclick1="show_image('<?php echo $row['file_upload']?>')" src="<?php echo $row['file_upload'] ?>" alt="Dinosaur"  height="120" />
					...
					if($row['file_type']==2)
					{
								...
								echo "<video   style='border:3px solid #000;' controls>";
...
Uploading a new photo</h5> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			 ...
			 <form method="post" name="add_screens" action="<?php echo base_url();?>index.php/screens/addpopupimage" enctype="multipart/form-data">
              <div class="media mb-6">
				...
				<section>
                                    ...
                                    <div class="col-sm-12 here_centerLine">
                                        <div class="row">
										<div class="col-sm-4">
										...
										<!--
										<div class="col-sm-4">
                                        <label for="video_file" ><input type="radio" name="file_type" id="video_file" value="3">File Url</label>
                                        </div>
										-->
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group" id="image_video_id">
                                                ...
                                                <input type="file" name="file_upload" class="form-control file_image" accept="image/*" required>
                                            </div>
                                           <!--
		...
		$.ajax({
			...
			success: function(response) 
			{
				...
				if(response>0)
				{
					...
					window.location.href="<?php echo base_url() ?>/playlists/playlistgallery";
					//https://purplemoontest.com/development/playlists/playlistgallery
