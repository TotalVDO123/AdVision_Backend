...
?>
  ...
  <section class="category">
    <div class="container">
        ...
        <h4 style="color:#FFF;">Create Schedules</h4>
...
<form action="<?php echo base_url() ?>Playlists/addschedule" method="post" >
  <div class="form-group">
    <label style="color:#fff;" >Schedules Name</label>
    <input type="text" class="form-control" name="schedules_name"  aria-describedby="emailHelp" placeholder="Schedules Name" required >
