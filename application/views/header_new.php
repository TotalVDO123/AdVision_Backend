...
<body>
  <section class="hbox stretch">
	...
	<aside class="bg-primary aside-sm" id="nav">
      <section class="vbox">
        <header class="dker nav-bar nav-bar-fixed-top" style="background-color:#0b1524">
		...
		<a href="#" class="nav-brand" data-toggle="fullscreen">
		  <img src="<?php echo base_url()?>assets/digital/images/Add_Vision_Logo.svg" style="width: 150px !important;">
		  </a>	
