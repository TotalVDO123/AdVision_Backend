      ...
      <ul>
        <li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon = "SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='MON'";
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon ="SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='TUE'";
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon="SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='WED'";
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon ="SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='THU'";
        ...
        <li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon ="SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='FRI'";
		...
		<li class="cd-schedule__group">
          ...
          <ul>
			...
			$sql_mon ="SELECT PS.*,PL.name as playlist_name  FROM  playlist_schedule PS left join playlists PL on PS.playlist_id= PL.id WHERE 	PS.section_id='".$sections[0]['id']."' and PS.player_id='".$player_id."' and PS.schedule_day='SAT'";
			$mon_data = $this->db->query($sql_mon);
		...
		<div class="modal-content"  style="background:#212529 !important;"  >
                ...
                <div class="col-sm-12" >
					...
					<tbody >
						...
						<input type="hidden" name="section_id" value="<?php echo $sections[0]['id'] ?>">
					...
					<th colspan="3">
                       ...
                       <tr class="w-75">
						...
						<th>
						<div>
							<input type="checkbox" id="scales" name="days[]" value="MON" checked />
