          ...
          <div class="rounded-3 text-black">
			...
			?>
                  ...
                  <div style="text-align: left !important;" >
                   <h6 class="mt-1 pb-1 user-heading">  <a href="<?php echo base_url() ?>index.php/users/companies_player/0/<?php echo $this->session->userdata('user_id') ?>"><i class="fa fa-arrow-left"></i></a> </h6> 
                  </div>
                 
                  
                  <div class="text-center">
                    <!--<h4 class="mt-1 pb-1 user-heading">Add Player</h4> -->
					<h4 class="mt-1 pb-1 user-heading">Add Screen</h4>
                  </div>
                  </div>
                                    <hr>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-outline mb-4"> 
                         ...
                         <!--<input type="text" id="form2Example11" class="form-control form-control1" placeholder="Full Name" />-->
						  <!--<label for="email"  style="color:#fff;" >Player Id:</label> -->
						  
						  <label for="email"  style="color:#fff;" >Screen Id:</label>
						  
						  <input class="form-control form-control1" type="text" name="player_id" value="" required>  
                        </div>
                      </div>
                        ...
                        <div class="form-outline mb-4"> 
                          ...
                          <!--<input type="text" id="form2Example12" class="form-control form-control1" placeholder="Last Name" />-->
						   <label for="email"  style="color:#fff;" >Screen Name:</label>
						    <input class="form-control form-control1" type="text" name="name" value="" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-outline mb-4"> 
						  ...
						  <input class="form-control form-control1" type="text" name="pin" value="" required>
                        </div>
                      </div>
                      ...
                      <div class="pb-4" align="right">
                        <button  class="btn btn-primary"type="submit" name="save" Value="save" ><i class="fa fa-floppy-o"></i> Save</button>
                      </div>
                    </div>
                  </form>
                </div>
