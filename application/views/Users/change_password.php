          ...
          <div class="rounded-3 text-black">
				 ...
				 <div class="col-lg-2 d-flex align-items-center bg1">
				  ...
				  <div class="col-lg-10 bg3">
					<div class="card-body  mx-md-4">
					  ...
					  <form method="post" action="<?php echo base_url();?>index.php/users/change_password" onsubmit="return validateForm()">
			...
			?>
							...
							<div class="form-outline mb-4"> 
							  ...
							  <input type="password"  class="form-control form-control1" name="new_password" id="new_password" placeholder="New Password" required />
							</div>
							<input type="hidden" name="task" value="update_password">
							
							<div class="form-outline mb-4"> 
							  <label class="form-label" for="form2Example11">Confirm New Password:</label>
							  <input type="password"  class="form-control form-control1" name="confirm_password" id="confirm_password" placeholder="Confirm New Password" required />
							</div>
