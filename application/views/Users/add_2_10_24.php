			...
			<?php /* ?>
              ...
              <div class="col-lg-10">
                <div class="card-body mx-md-4">
                  ...
                  <form method="post" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>index.php/users/add">
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        <div class="form-outline mb-4"> 
                          ...
                          <!--<input type="text" id="form2Example12" class="form-control form-control1" placeholder="Last Name" />-->
						   <input class="form-control form-control1" type="text" name="first_name" placeholder="First Name" onkeypress="return ((event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 8 || (event.charCode >= 48 && event.charCode <= 57));" value="" required>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-outline mb-4"> 
                      ...
                      <div class="col-md-6">
                        <div class="form-outline mb-4"> 
                         ...
                         <!-- <input type="text" id="form2Example14" class="form-control form-control1" placeholder="Phone Number" /> -->
						  ...
						  <input class="form-control form-control1" type="text" name="last_name" placeholder="Last name" onkeypress="return ((event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || event.charCode == 8 || (event.charCode >= 48 && event.charCode <= 57));" value="" required>
