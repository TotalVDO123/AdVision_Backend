(function() {
	...
	function ScheduleTemplate( element ) {
		...
		this.timelineUnitDuration = getScheduleTimestamp(this.timelineItems[1].textContent) - getScheduleTimestamp(this.timelineItems[0].textContent+45);
		
		this.topInfoElement = this.element.getElementsByClassName('cd-schedule__top-info')[0];
		
		//alert(this.topInfoElement);
		//console.log(this.topInfoElement);
	...
	ScheduleTemplate.prototype.placeEvents = function() {
		...
		for(var i = 0; i < this.singleEvents.length; i++) {
			...
			var eventTop = slotHeight*(start - self.timelineStart)/self.timelineUnitDuration,
				...
				//alert(self.timelineUnitDuration);
